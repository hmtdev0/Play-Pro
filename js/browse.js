            ...
            children: [
                {
                    ...
                    type: "folder",
                    children: [
                        { name: "PM_1_Impact 01 Strong.wav", type: "file", path: "./Media/Impacts/Impacts1", track: "Impacts/Impacts1/PM_1_Impact 01 Strong.png" },
                        { name: "PM_1_Impact 02 Quick.wav", type: "file", path: "./Media/Impacts/Impacts1", track: "Impacts/Impacts1/PM_1_Impact 02 Quick.png" },
                        { name: "PM_1_Impact 03 Epic.wav", type: "file", path: "./Media/Impacts/Impacts1", track: "Impacts/Impacts1/PM_1_Impact 03 Epic.png" },
                    ]
                },
                {
                    name: "Impact2",
                    type: "folder",
                    children: [
                        { name: "PM_2_Impact 01 Strong.wav", type: "file", path: "./Media/Impacts/Impacts2", track: "Impacts/Impacts1/PM_2_Impact 01 Strong.png" },
                        { name: "PM_2_Impact 02 Quick.wav", type: "file", path: "./Media/Impacts/Impacts2", track: "Impacts/Impacts1/PM_2_Impact 02 Quick.png" },
                        { name: "PM_2_Impact 03 Epic.wav", type: "file", path: "./Media/Impacts/Impacts2", track: "Impacts/Impacts1/PM_2_Impact 03 Epic.png" },
                    ]
                },
            ]
        },
            ...
            children: [
                {
                    ...
                    type: "folder",
                    children: [
                        { name: "PM_1_Transition 01 Strong.wav", type: "file", path: "/Media/Transitions/Transitions1", track: "Transitions/Transitions1/PM_1_Transition 01 Strong.png" },
                        { name: "PM_1_Transition 02 Quick.wav", type: "file", path: "/Media/Transitions/Transitions1", track: "Transitions/Transitions1/PM_1_Transition 02 Quick.png" },
                        { name: "PM_1_Transition 03 Epic.wav", type: "file", path: "/Media/Transitions/Transitions1", track: "Transitions/Transitions1/PM_1_Transition 03 Epic.png" },
                    ]
                },
                {
                    name: "Transition2",
                    type: "folder",
                    children: [
                        { name: "PM_2_Transition 01 Strong.wav", type: "file", path: "/Media/Transitions/Transitions2", track: "Transitions/Transitions2/PM_2_Transition 01 Strong.png" },
                        { name: "PM_2_Transition 02 Quick.wav", type: "file", path: "/Media/Transitions/Transitions2", track: "Transitions/Transitions2/PM_2_Transition 02 Quick.png" },
                        { name: "PM_2_Transition 03 Epic.wav", type: "file", path: "/Media/Transitions/Transitions2", track: "Transitions/Transitions2/PM_2_Transition 03 Epic.png" },
                    ]
                },
            ]
        },
    ...
    document.getElementById("favorites_list").innerHTML = favorites.map((fav) => {
        ...
        <li class="flex p-2 items-center justify-between">
           <div class="flex items-center">
            ...
            <button type="button" class="bg-transparent border-none star-icon remove-favorites" style="color: #3391e6;" data-files="${displayFileName}">
                    <i>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#3391e6" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="size-6" style="width: 25px;">
